	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form  method="post" action="{{url('checklogin')}}" class="login100-form validate-form">
            <input type="hidden" name="_token" value="{{ csrf_token()}}">
               ...
               <a href="{{url('register')}}" class="txt2"><input type="button" class="btn btn-warning" value="Sign up"/></a>
					</div>
