  ...
  <body>
    ...
    <!-- Product-Section-Strat  -->
     ...
     <form method="post" action="{{url('admin/store')}}">
                ...
                <tr><td>Image_name:</td><td><input type="text" name="pimage" required></td></tr>
                ...
                <tr><td colspan="2"><input type="submit" class="btn btn-warning" value="ADD"/></td></tr>
            </table>  
          </form>
		...
		<div class="padding_right main_single_product">
			<div class="single_product">
				<div class="product_img">
					<img id="immg" src="{{url('/design/images/product/', ['id' => $value->image])}}" alt="DARK BLUE IMAGE" />
				</div>
			...
			<div class="single_product single_product_two">
				...
				<div class="product_text_two product_text">
                   <form method="post" action="{{url('admin/update')}}">
					...
					<table id="my-tbl">
			        <tr><th colspan="2">Product Infocrmation</th></tr>
					
                    <tr><td>Name:</td><td><input type="text" name="name" value="{{$value->name}}"></td></tr>
                    <tr><td>Image_name:</td><td><input type="text" name="pimage" value="{{$value->image}}"></td></tr>
                    <tr><td>Price:</td><td><input type="number" name="price" value="{{$value->price}}"></td></tr>
                    <tr><td>Quantity:</td><td><input type="number" name="quantity" value="{{$value->quantity}}"></td></tr>
                    <tr><td colspan="2"><input type="submit" class="btn btn-warning" value="Update"/></td></tr>                
                    <tr><td colspan="2"><a href="{{url('admin',['id'=>$value->id])}}"><input type="button" class="btn btn-warning" value="Delete"/></a></td></tr>
					</table> 
                </form>
